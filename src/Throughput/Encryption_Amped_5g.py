...
#                  file.write(str(BW_MODE) + ' BW='+str(BW_width)+ ' ' + str(Encryption)  + ' Channel' + str(channel5g_a)  +' '+str(test_script)+"\n")
...
#                  file.write(str(format_value) +"\n")
                 ...
                 file.write(str(format_value)+ '    ' + str(BW_MODE) + ' BW='+str(BW_width)+ ' ' + str(Encryption)  + ' Channel' + str(channel5g_a)  +' '+str(test_script)+"\n")
                 ...
                 try :   
                  for filename in os.listdir(chariot_path):
                    ...
                    if filename.endswith(str(Encryption)+'.html'): 
                         ...
                         os.chdir(chariot_path)
                         os.rename(filename,str(test_script)+'Channel '+str(j)+'   '+ '5G AC' + '    ' + str(BW_MODE)+ '   '+ str(Encryption)+'.html')
                      
                    elif filename.endswith("S_resp_time.gif"):
                             os.chdir(chariot_path)
                             os.rename(filename,str(test_script)+'Channel '+str(j)+'   '+ '5G AC' + '    ' + str(BW_MODE)+ '   '+ str(Encryption)+'_resp_time.gif')
                            
                    elif filename.endswith("S_throughput.gif"):
                             os.chdir(chariot_path)
                             os.rename(filename,str(test_script)+'Channel '+str(j)+'   '+ '5G AC' + '    ' + str(BW_MODE)+ '   '+ str(Encryption)+'_throughput.gif')
                          
                    elif filename.endswith("S_trans_rate.gif"):
                             os.chdir(chariot_path)
                             os.rename(filename,str(test_script)+'Channel '+str(j)+'   '+ '5G AC' + '    ' + str(BW_MODE)+ '   '+ str(Encryption)+'_trans_rate.gif')
                 ...
                 try :   
                  for filename in os.listdir(chariot_path):
                    ...
                    if filename.endswith(str(Encryption)+'.html'): 
                         ...
                         os.chdir(chariot_path)
                         os.rename(filename,str(test_script)+'Channel '+str(j)+'   '+ '5G AC' + '   '+ str(Encryption)+'.html')
                      
                    elif filename.endswith("H_resp_time.gif"):
                             os.chdir(chariot_path)
                             os.rename(filename,str(test_script)+'Channel '+str(j)+'   '+ '5G AC' + '   '+ str(Encryption)+'_resp_time.gif')
                            
                    elif filename.endswith("H_throughput.gif"):
                             os.chdir(chariot_path)
                             os.rename(filename,str(test_script)+'Channel '+str(j)+'   '+ '5G AC' + '   '+ str(Encryption)+'_throughput.gif')
                          
                    elif filename.endswith("H_trans_rate.gif"):
                             os.chdir(chariot_path)
                             os.rename(filename,str(test_script)+'Channel '+str(j)+'   '+ '5G AC' + '   '+ str(Encryption)+'_trans_rate.gif')
            ...
            #             print match_time
                ...
                #                 print match_name
                 ...
                 file.write('Error'+ '    ' + str(BW_MODE) + ' BW='+str(BW_width)+ ' ' + str(Encryption)  + ' Channel' + str(channel5g_a)  +' '+str(test_script)+"\n")
