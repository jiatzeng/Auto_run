...
#                 print match_name
    ...
    file.write('          5G AC 5M BW=20~80  Open'+"\n" +"\n"+"\n")
             ...
             try :
              if 'root' in content :
                 ...
                 try :
                     ...
                     time.sleep(5)
                     cmd = 'wl -i eth2 sta_info '+str(MAC)+' | grep average'
                     print cmd
                     time.sleep(3)
                     tn.write(str(cmd)+"\r\n")
                     time.sleep(5)
...
#                  if str(Authentication5g) == str(Authentication5g) :
             ...
             try :
                 ...
                 file.write(' Channel ' + str(j) + '   Throughtput = ' +str(format_value) +'    RSSI = '+str(RSSI)+'    BW '+str(u) +'      script ' + str(test_script)+"\n") 
             ...
             try :   
                  for filename in os.listdir(chariot_path):
                    ...
                    if filename.endswith('Open'+'.html'): 
                         ...
                         os.chdir(chariot_path)
                         os.rename(filename,str(test_script)+'Channel '+str(j)+'   '+ '5G AC' +'    BW '+str(u)+ '   '+ 'Open'+'.html')
                      
                    elif filename.endswith("P.gif"):
                             os.chdir(chariot_path)
                             os.rename(filename,str(test_script)+'Channel '+str(j)+'   '+ '5G AC' +'    BW '+str(u)+ '   '+ 'Open'+'_resp_time.gif')
                            
                    elif filename.endswith("P.gif"):
                             os.chdir(chariot_path)
                             os.rename(filename,str(test_script)+'Channel '+str(j)+'   '+ '5G AC' +'    BW '+str(u)+'   '+'Open'+'_throughput.gif')
                          
                    elif filename.endswith("P.gif"):
                             os.chdir(chariot_path)
                             os.rename(filename,str(test_script)+'Channel '+str(j)+'   '+ '5G AC' +'    BW '+str(u)+'   '+ 'Open'+'_trans_rate.gif')
