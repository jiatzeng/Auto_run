...
#                 print match_name
    ...
    file.write('          2.4G BGN 5M BW=40 WPA2-AES'+"\n" +"\n"+"\n")
    ...
    for j in channel_range_text:  
      ...
      if j == 5 or j == 6 or j== 7 :
       ...
       try :
          ...
          Select(driver.find_element_by_name('chan_band_width')).select_by_value('6')
        ...
        try :
          ...
          Select(driver.find_element_by_name("chan_band_width")).select_by_value('5')
         ...
         try :   
                  for filename in os.listdir(chariot_path):
                    ...
                    if filename.endswith('WPA2-AES'+'.html'): 
                         ...
                         os.chdir(chariot_path)
                         os.rename(filename,str(test_script)+'Channel '+str(j)+'   '+ '2.4G BGN' + '   '+ 'WPA2-AES'+'.html')
                      
                    elif filename.endswith("H_resp_time.gif"):
                             os.chdir(chariot_path)
                             os.rename(filename,str(test_script)+'Channel '+str(j)+'   '+ '2.4G BGN' + '   '+ 'WPA2-AES'+'_resp_time.gif')
                            
                    elif filename.endswith("H_throughput.gif"):
                             os.chdir(chariot_path)
                             os.rename(filename,str(test_script)+'Channel '+str(j)+'   '+ '2.4G BGN' + '   '+'WPA2-AES'+'_throughput.gif')
                          
                    elif filename.endswith("H_trans_rate.gif"):
                             os.chdir(chariot_path)
                             os.rename(filename,str(test_script)+'Channel '+str(j)+'   '+ '2.4G BGN' + '   '+ 'WPA2-AES'+'_trans_rate.gif')
